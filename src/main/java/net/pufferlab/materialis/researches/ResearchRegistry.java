...
public class ResearchRegistry {
    ...
    public static void init() {
        ResearchCategories
            .registerCategory("BOTANY", ResearchRegistry.BOTANIA_ICON, ResearchRegistry.RESEARCH_BACKGROUND);
        ResearchCategories
            .registerCategory("BLOODMAGIC", ResearchRegistry.BLOODMAGIC_ICON, ResearchRegistry.RESEARCH_BACKGROUND);
    }
}
