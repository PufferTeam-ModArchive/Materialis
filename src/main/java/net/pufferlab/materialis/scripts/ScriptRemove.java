...
public class ScriptRemove implements IScript {
    ...
    public static final String[] itemsToRemoveAndHide = new String[] { "minecraft:wooden_sword:*:*",
        ...
        "BiomesOPlenty:scytheIron:*:*", "BiomesOPlenty:scytheGold:*:*", "BiomesOPlenty:scytheDiamond:*:*",
        "BiomesOPlenty:scytheAmethyst:*:*", "BiomesOPlenty:swordAmethyst:*:*", "BiomesOPlenty:shovelAmethyst:*:*",
        "BiomesOPlenty:pickaxeAmethyst:*:*", "BiomesOPlenty:axeAmethyst:*:*", "BiomesOPlenty:hoeAmethyst:*:*",
        "BiomesOPlenty:helmetAmethyst:*:*", "BiomesOPlenty:chestplateAmethyst:*:*",
        "BiomesOPlenty:leggingsAmethyst:*:*", "BiomesOPlenty:bootsAmethyst:*:*", "BiomesOPlenty:mudBricks:0:*",
        "BiomesOPlenty:mudBricksStairs:*:*", "BiomesOPlenty:stoneSingleSlab:0:*", "TConstruct:metalPattern:*:*",
        "TConstruct:clayPattern:*:*", "TConstruct:Smeltery:4:*", "TConstruct:Smeltery:5:*",
        "TConstruct:SmelteryNether:4:*", "TConstruct:SmelteryNether:5:*", "BiblioCraft:BiblioPaneler:0",
        ...
        "Botania:stone11Stairs:0:*", "Botania:stone11Slab:0:*", "Botania:endStoneBrick:0:*",
        "Botania:endStoneBrick:1:*", "Botania:endStoneBrick:2:*", "Botania:endStoneBrick:3:*",
        "Botania:endStoneBrick0Stairs:*:*", "endStoneBrick2Stairs:*:*", "Botania:endStoneBrick0Slab:*:*",
        "endStoneBrick2Slab:*:*", "ForbiddenMagic:FMResource:2:*", "ForbiddenMagic:FMResource:4:*",
        "etfuturum:copper_ore:0:*", "etfuturum:copper_ingot:0:*", "netherlicious:NetherbrickWall:4:*",
        "netherlicious:NetherbrickWall:6:*", "netherlicious:NetherbrickWall:8:*", "netherlicious:NetherbrickWall:10:*",
        "netherlicious:NetherbrickWall:13:*", "witchery:ingredient:52:*", "witchery:ingredient:53:*",
        "witchery:ingredient:54:*", "witchery:ingredient:152:*", "GardenStuff:iron_nugget:0:*", "jaff:iron_nugget:0:*",
        "ForgeMicroblock:sawStone:*:*", "ImmersiveEngineering:mold:*:*" };
